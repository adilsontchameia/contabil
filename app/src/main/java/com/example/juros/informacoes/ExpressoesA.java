...
import com.example.juros.adapters.AdapterExpressoes;
import com.example.juros.models.ModelExpressoes;

import java.util.ArrayList;
import java.util.List;

public class ExpressoesA extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_expressoes2);
    ...
    private void criarExpressoes() {
        ModelExpressoes modelExpressoes = new ModelExpressoes("AAA", "R.string.open_drawer");
